        ...
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-6 bg-slate-900/90 backdrop-blur-xl">
           <div className="bg-white rounded-[48px] w-full max-w-xl p-10 text-center shadow-2xl animate-in zoom-in-95">
              ...
              <p className="text-sm text-slate-500 font-bold leading-relaxed mb-8">
                ...
                تم تحديث الواجهة لتظهر جميع البيانات والخريطة في شاشة واحدة لتسهيل العمل.
              </p>
        ...
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="flex items-center gap-3">
              ...
              <h1 className="hidden sm:block text-xl font-black tracking-tight">InfraTrack</h1>
            </div>
            <div className="flex-1 flex gap-2">
              ...
              <button onClick={() => setShowNewProjectModal(true)} className="w-11 h-11 bg-blue-600 text-white rounded-2xl flex items-center justify-center hover:bg-blue-500 transition-all shadow-lg">
      ...
      <main className="container mx-auto px-4 mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9 space-y-8">
            ...
            {/* Section: Data & Management (Bottom Part) */}
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
              ...
              {/* Management Panel */}
              <div className="xl:col-span-4" id="management-section">
                <ManagementPanel 
          ...
          <div className="lg:col-span-3">
             <div className="bg-slate-900 rounded-[32px] p-6 text-white shadow-2xl lg:sticky lg:top-28">
               <h4 className="text-[10px] font-black mb-6 uppercase text-slate-500 tracking-widest flex items-center gap-2"><i className="fas fa-history"></i> السجل الميداني اللحظي</h4>
